...
namespace ALogic.Logic.Heplers
{
    public class ExcelXMLtoDataTable
    {
        ...
        public static DataSet ImportExcelXML(string fileName, bool hasHeaders, bool autoDetectColumnType)
        {
            ...
            {
                //MessageBox.Show("Закройте пожалуйса файл", "Ошибка при открытии файла", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                ALogic.Logic.Old.Logger.WriteErrorMessage("Ошибка при открытии файла: " + fileName + ", " + ex.Message);
            }
            return null;
