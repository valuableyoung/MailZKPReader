using AForm.Base;
using ALogic.Model.Entites.Kontr;
using System;
...
{
    public partial class CompanyEdit2 : AWindow
    {
        CompanyEntity _entity;
        public CompanyEdit2()
        {
            InitializeComponent();
            this.Tag = this.Text = "Редактирование контрагента";
        }
        ...
        {
            xtpDept.PageVisible = (sender as DevExpress.XtraEditors.CheckEdit).Checked;
            xtpPotential.PageVisible = (sender as DevExpress.XtraEditors.CheckEdit).Checked;
            xtpWork.PageVisible = (sender as DevExpress.XtraEditors.CheckEdit).Checked;
        }

        private void ReUr_CheckedChanged(object sender, EventArgs e)
        {
            xtpHos.PageVisible = (sender as DevExpress.XtraEditors.CheckEdit).Checked;
            xtpEmeil.PageVisible = xtpHos.PageVisible;
            xtpTD.PageVisible = xtpHos.PageVisible;
            xtpContract.PageVisible = xtpHos.PageVisible;
        }
